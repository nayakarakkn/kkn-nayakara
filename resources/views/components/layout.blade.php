            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-slate-800">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/kkn.nayakara/reels/" target="_blank" rel="noopener noreferrer" class="flex items-center p-2.5 bg-slate-800/80 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 rounded-xl border border-slate-700/80 text-white text-xs font-semibold transition-all group shadow-sm hover:-translate-y-0.5">
