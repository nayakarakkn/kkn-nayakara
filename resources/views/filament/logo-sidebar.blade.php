<div style="padding: 1.15rem 1.25rem 0.95rem 1.25rem; margin-bottom: 0.5rem; border-bottom: 1px solid #f1f5f9;">
    <div style="display: flex; align-items: center; gap: 0.95rem; cursor: pointer;">
        ...
        <div style="display: flex; flex-direction: column; justify-content: center; line-height: 1.2;">
            <span style="font-size: 1.25rem; font-weight: 600; color: #0f172a; letter-spacing: -0.015em; white-space: nowrap;">
                Keranggan
            </span>
            <span style="font-size: 0.685rem; font-weight: 600; color: #059669; letter-spacing: 0.04em; text-transform: uppercase; white-space: nowrap; margin-top: 2px;">
